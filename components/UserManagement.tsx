    ...
    <div className="space-y-6">
        <div className="flex justify-between items-center">
            <div>
                ...
                <p className="text-sm text-gray-500">Gerencie o acesso e as funções para a organização</p>
            </div>
            <button 
            ...
            >
                <Info size={18} />
                <span>Como Adicionar Usuários</span>
            </button>
        </div>
                        ...
                        <tr key={user.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4">
                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                                    ...
                                    {user.role === 'ADMIN' ? 'Desenvolvedor / Admin' : 'Usuário Padrão'}
                                </span>
                            </td>
                            <td className="px-6 py-4">
                                <button 
        ...
        {showModal && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6 m-4">
                    <h3 className="text-lg font-bold text-gray-900 mb-4">Adicionando Novos Usuários</h3>
                    <p className="text-gray-600 mb-4">
                        Para adicionar um novo usuário ao sistema, peça para que ele faça o <strong>Cadastro (Sign Up)</strong> na página de login.
                    </p>
                    <p className="text-gray-600 mb-4">
                        Assim que ele se cadastrar, aparecerá nesta lista como "Usuário Padrão". Você poderá então promovê-lo a "Admin" usando os botões de ação na tabela.
                    </p>
