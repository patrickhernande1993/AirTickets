    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-end pb-2 border-b border-gray-100">
        <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Resumo da operação hoje.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto pr-2 space-y-5 max-h-[400px]">
                {logs.length === 0 ? (
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex justify-between items-baseline mb-0.5">
                                    <p className="text-sm font-medium text-gray-900 truncate">
                                        Chamado #{log.ticketId ? log.ticketId.slice(0,4) : '???'}
                                    </p>
                                ...
                                <p className="text-xs text-gray-500 mb-1">
                                    <span className="capitalize text-gray-700 font-medium">{translateLogAction(log.action)}</span> por {log.actorName.split(' ')[0]}
                                </p>
                            </div>
                        </div>
                    ))
